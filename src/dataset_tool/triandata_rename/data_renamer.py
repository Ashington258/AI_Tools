...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, QLabel, 
                             QPushButton, QFileDialog, QCheckBox, QHBoxLayout, QProgressBar)
...
class TitleBar(QWidget):
    ...
    def initUI(self):
        ...
        close_button.setStyleSheet("background-color: #d9534f; color: #ffffff; border: none;")
...
class RenameApp(QMainWindow):
    ...
    def rename_files(self):
        ...
        if not self.output_path:
            self.output_label.setText('Output Path: Not Selected (Please select a path)')
            return
